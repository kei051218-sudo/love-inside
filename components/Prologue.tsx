  ...
  return (
    <div className="min-h-screen flex flex-col relative">
      ...
      <div className="absolute inset-0"
        style={{ backgroundImage: 'url(/bg-title.png)', backgroundSize: 'cover', backgroundPosition: 'center top' }} />
      <div className="absolute inset-0" style={{ background: 'rgba(253,240,235,0.7)' }} />

      <div className="relative z-10 px-7 py-10 max-w-sm mx-auto w-full flex flex-col min-h-screen">
        {/* 시간 */}
