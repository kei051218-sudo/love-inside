...
const SCRIPT_B: Record<string, PhaseScript> = {
  ...
  phase2: {
    turn1: {
      ...
      choices: [
        { id: 'b-feel2-unfair',   text: '억울하다', sub: '난 정말 최선을 다했는데, 뭐가 문제였던거야?' },
        { id: 'b-feel2-sorry',    text: '미안하다', sub: '이유가 무엇이든, 네가 속상했던 것 같아서 그게 미안해.' },
        { id: 'b-feel2-confused', text: '이해가 안 간다', sub: '뭐가 문제인지 정확히 모르겠어. 말해주면 안되겠니?' },
        { id: 'b-feel2-empathy',  text: '걱정돼', sub: '내가 무엇을 잘못했는지는 잘 모르겠지만, 네가 걱정돼.' },
      ],
    },
    turn2: {
      lines: [
      ...
      myLine: {
        ...
        dukeun: '"미안해. 그게 그렇게 신경쓰였어? 내가 더 신경썼어야 했는데."',
        honmi:  '"그랬구나... 나 진짜 몰랐어. 미안해."',
        dodo:   '"오늘은 그냥 자. 내일 차분하게 얘기하자."',
      },
      choices: [
        { id: 'b-apologize2',  text: '미안하다고 한다', sub: '"미안해, 내가 눈치가 없었어."' },
        { id: 'b-ask-detail',  text: '이해해보려 한다', sub: '"난 잘한다고 노력한건데, 그렇게 생각할줄 몰랐어. 미안해."' },
