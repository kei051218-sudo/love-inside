...
type PhaseScript = {
  turn1: {
    lines: EmotionLine[];
    defaultLine: Record<EmotionCharacter, string>;
  ...
  turn2: {
    ...
    defaultLine: Record<EmotionCharacter, string>;
    choices: ChoiceOption[];
    choiceLines: Record<string, string>; // 선택지 id → 실제 출력 대사
  };
};
...
const SCRIPT_A: Record<string, PhaseScript> = {
  phase1: {
    turn1: {
      ...
      choices: [
        { id: 'a1t1-angry',    text: '화가 난다', sub: '억울하고 이해가 안 돼' },
        { id: 'a1t1-sad',      text: '서럽다', sub: '1주년인데 이렇게 됐어' },
        { id: 'a1t1-miss',     text: '보고 싶다', sub: '오늘 이대로 끝내기 싫어' },
        { id: 'a1t1-confused', text: '모르겠다', sub: '내 감정이 뭔지 모르겠어' },
        { id: 'a1t1-cold',     text: '기다린다', sub: '먼저 연락 안 해' },
      ],
    },
    turn2: {
      lines: [
      ...
      choices: [
        { id: 'a1t2-apologize',   text: '차분하게 사과하며 이유를 설명한다', sub: '"말없이 가버려서 미안해. 근데 나 오늘 많이 속상했어."' },
        { id: 'a1t2-short-sorry', text: '가버린 것만 짧게 사과한다', sub: '"그렇게 가버린 건 미안해. 근데 할 말은 있어."' },
        { id: 'a1t2-confront',    text: '다짜고짜 묻는다', sub: '"어떻게 그럴 수가 있어?"' },
        { id: 'a1t2-vent',        text: '쌓인 감정을 토로한다', sub: '"굳이 내 친구한테까지 새우에 한라봉까지 까줄 필요가 있어?"' },
        { id: 'a1t2-silent',      text: '아무 말 않고 듣는다' },
      ],
      choiceLines: {
        'a1t2-apologize':   '말없이 가버려서 미안해. 근데 나 오늘 많이 속상했어.',
        'a1t2-short-sorry': '그렇게 가버린 건 미안해. 근데 할 말은 있어.',
        'a1t2-confront':    '어떻게 그럴 수가 있어?',
        'a1t2-vent':        '굳이 내 친구한테까지 새우에 한라봉까지 까줄 필요가 있어?',
        'a1t2-silent':      '...(말없이 듣는다)',
      },
    },
  },
  phase2: {
    turn1: {
      ...
      choices: [
        { id: 'a2t1-betrayed', text: '배신감이 든다', sub: '나한테만 친절했으면 좋겠어' },
        { id: 'a2t1-tired',    text: '지친다', sub: '매번 이렇게 혼자 삭혀왔어' },
        { id: 'a2t1-confused', text: '헷갈린다', sub: '걔가 나쁜 건지 내가 예민한 건지' },
        { id: 'a2t1-curious',  text: '궁금하다', sub: '그 친구가 눈에 들어왔던 건지 직접 묻고 싶어' },
      ],
    },
    turn2: {
      lines: [
      ...
      choices: [
        { id: 'a2t2-vent-all',     text: '쌓인 감정을 털어놓는다', sub: '"사실 오늘만의 얘기가 아니야. 항상 나한테만 친절했으면 좋겠다고 했잖아."' },
        { id: 'a2t2-ask-direct',   text: '직접 묻는다', sub: '"솔직히 얘기해봐. 오늘 내 친구가 눈에 들어온 거야?"' },
        { id: 'a2t2-ask-indirect', text: '돌려서 묻는다', sub: '"우리 기념일인데 자기가 더 꾸미고 오냐구."' },
        { id: 'a2t2-give-up',      text: '오늘은 더 이상 얘기하지 않는다', sub: '"됐어. 오늘은 그냥 자자."' },
      ],
      choiceLines: {
        'a2t2-vent-all':     '사실 오늘만의 얘기가 아니야. 항상 나한테만 친절했으면 좋겠다고 했잖아.',
        'a2t2-ask-direct':   '솔직히 얘기해봐. 오늘 내 친구가 눈에 들어온 거야?',
        'a2t2-ask-indirect': '우리 기념일인데 자기가 더 꾸미고 오냐구.',
        'a2t2-give-up':      '됐어. 오늘은 그냥 자자.',
      },
    },
  },
  phase3: {
    turn1: {
      ...
      choices: [
        { id: 'a3t1-angry',  text: '화가 아직 안 풀렸다', sub: '만나면 더 싸울 것 같아' },
        { id: 'a3t1-miss',   text: '그래도 보고 싶다', sub: '얼굴 보면 나아질 것 같아' },
        { id: 'a3t1-tired',  text: '그냥 쉬고 싶다', sub: '오늘은 혼자 있고 싶어' },
        { id: 'a3t1-unsure', text: '모르겠다', sub: '만날지 말지 결정이 안 서' },
      ],
    },
    turn2: {
      lines: [
      ...
      choices: [
        { id: 'a3t2-meet',       text: '만난다', sub: '"...와. 근데 올 거면 빨리 와."' },
        { id: 'a3t2-no-meet',    text: '오늘은 만나지 않는다', sub: '"오늘은 그냥 자. 내일 얘기하자."' },
        { id: 'a3t2-let-decide', text: '연인한테 결정을 맡긴다', sub: '"모르겠어. 네가 결정해."' },
      ],
      choiceLines: {
        'a3t2-meet':       '...와. 근데 올 거면 빨리 와.',
        'a3t2-no-meet':    '오늘은 그냥 자. 내일 얘기하자.',
        'a3t2-let-decide': '...모르겠어. 네가 결정해.',
      },
    },
  },
  phase4: {
    turn1: {
      ...
      choices: [
        { id: 'a4t1-proud',  text: '자존심이 걸린다', sub: '내가 먼저 나가면 지는 것 같아' },
        { id: 'a4t1-miss',   text: '빨리 보고 싶다', sub: '그냥 나가고 싶어' },
        { id: 'a4t1-unsure', text: '어색할 것 같다', sub: '막상 보면 뭐라고 해야 할지 모르겠어' },
        { id: 'a4t1-wait',   text: '기다리고 싶다', sub: '걔가 먼저 말하게 할 거야' },
      ],
    },
    turn2: {
      lines: [
      ...
      choices: [
        { id: 'a4t2-go-out', text: '나가서 맞이한다' },
        { id: 'a4t2-let-in', text: '들어오라고 한다' },
      ],
      choiceLines: {
        'a4t2-go-out': '(문을 열고 나간다)',
        'a4t2-let-in': '들어와.',
      },
    },
  },
  phase5: {
    turn1: {
      ...
      choices: [
        { id: 'a5t1-blank', text: '할 말이 없어졌다', sub: '막상 보니까 아무 말도 안 나와' },
        { id: 'a5t1-cry',   text: '울 것 같다', sub: '눈물이 나올 것 같아' },
        { id: 'a5t1-hug',   text: '안기고 싶다', sub: '말보다 안아줬으면 좋겠어' },
        { id: 'a5t1-wait',  text: '기다린다', sub: '걔가 먼저 말하게 할 거야' },
      ],
    },
    turn2: {
      lines: [
      ...
      choices: [
        { id: 'a5t2-sorry',       text: '"미안해."' },
        { id: 'a5t2-miss',        text: '"보고 싶었어."' },
        { id: 'a5t2-still-angry', text: '"아직 화 안 풀렸어."' },
        { id: 'a5t2-hug',         text: '말없이 안긴다' },
      ],
      choiceLines: {
        'a5t2-sorry':       '미안해.',
        'a5t2-miss':        '보고 싶었어.',
        'a5t2-still-angry': '아직 화 안 풀렸어.',
        'a5t2-hug':         '(말없이 안긴다)',
      },
    },
  },
...
const SCRIPT_B: Record<string, PhaseScript> = {
  phase1: {
    turn1: {
      ...
      choices: [
        { id: 'b1t1-confused', text: '당황스럽다', sub: '갑자기 나가버려서 이해가 안 돼' },
        { id: 'b1t1-unfair',   text: '억울하다', sub: '내가 뭘 잘못했는지 모르겠어' },
        { id: 'b1t1-worried',  text: '걱정된다', sub: '연인이 많이 속상한 것 같아서' },
        { id: 'b1t1-sorry',    text: '미안한 것 같다', sub: '내가 뭔가 놓친 것 같아' },
        { id: 'b1t1-lost',     text: '모르겠다', sub: '뭘 어떻게 해야 할지' },
      ],
    },
    turn2: {
      lines: [
      ...
      defaultLine: {
        ...
        seorup: '"지금 어디야? 집에는 잘 들어갔어? 걱정돼서 전화했어."',
        dukeun: '"미안해. 보고 싶어."',
        honmi:  '"오늘 어떤 부분에서 화가 난 거야? 먼저 말해줬으면 좋겠어."',
        dodo:   '"지금 어디야? 보고 싶어."',
      },
      choices: [
        { id: 'b1t2-confront',  text: '매번 이러는 거 아닌 것 같다고 말한다', sub: '"매번 화난다고 집에 가는 거, 갈등 해결에 도움이 되지 않는 것 같아."' },
        { id: 'b1t2-worry',     text: '걱정된다고 먼저 말한다', sub: '"지금 어디야? 집에는 잘 들어갔어? 걱정돼서 전화했어."' },
        { id: 'b1t2-ask-why',   text: '이유를 먼저 묻는다', sub: '"오늘 어떤 부분에서 화가 난 거야? 먼저 말해줬으면 좋겠어."' },
        { id: 'b1t2-apologize', text: '미안하다고 한다', sub: '"미안해, 내가 잘못했어."' },
        { id: 'b1t2-miss',      text: '보고 싶다고 한다', sub: '"지금 어디야? 보고 싶어."' },
        { id: 'b1t2-silent',    text: '아무 말 않고 기다린다' },
      ],
      choiceLines: {
        'b1t2-confront':  '매번 화난다고 집에 가는 거, 갈등 해결에 도움이 되지 않는 것 같아.',
        'b1t2-worry':     '지금 어디야? 집에는 잘 들어갔어? 걱정돼서 전화했어.',
        'b1t2-ask-why':   '오늘 어떤 부분에서 화가 난 거야? 먼저 말해줬으면 좋겠어.',
        'b1t2-apologize': '미안해, 내가 잘못했어.',
        'b1t2-miss':      '지금 어디야? 보고 싶어.',
        'b1t2-silent':    '...(말없이 기다린다)',
      },
    },
  },
  phase2: {
    turn1: {
      lines: [
        { character: 'buni',   text: '오늘 날 최선을 다했어! 도대체 뭐가 문제인거야! 서운하면 말을 하면 되는 거 아냐?' },
        { character: 'seorup', text: '...나 진짜 모르겠어. 그래서 더 슬퍼.. 자꾸 눈물이 날 것 같아.' },
        { character: 'honmi',  text: '뭔가 불편하다는 내색을 하긴 했어. 근데 내가 제대로 의도파악을 못한 것 같아. 아 어려워 연애라는 거.' },
        { character: 'dodo',   text: '감정적으로 받지 마. 연인이 화난 이유가 뭔지 정확히 파악하는 게 먼저야.' },
        { character: 'dukeun', text: '휴, 난 잘한다고 한건데. 뭐가 그렇게 서운했던걸까? 걱정돼.' },
      ],
      defaultLine: {
        buni:   '난 오늘 최선을 다했어. 뭐가 잘못이야?',
        seorup: '불편한게 있었다면 말해줬으면 좋았을텐데.',
        dukeun: '오늘 뭐가 서운했었는지 말해줄 수 있어?',
        honmi:  '으아, 모르겠어. 뭐가 문제였을까?',
        dodo:   '화난 이유를 정확히 파악하는 게 먼저야.',
      },
      choices: [
        { id: 'b2t1-unfair',   text: '억울하다', sub: '난 정말 최선을 다했는데, 뭐가 문제였던 거야?' },
        { id: 'b2t1-sorry',    text: '미안하다', sub: '이유가 무엇이든, 네가 속상했던 것 같아서 그게 미안해.' },
        { id: 'b2t1-confused', text: '이해가 안 간다', sub: '뭐가 문제인지 정확히 모르겠어. 말해주면 안 되겠니?' },
        { id: 'b2t1-worried',  text: '걱정된다', sub: '내가 무엇을 잘못했는지는 잘 모르겠지만, 네가 걱정돼.' },
      ],
    },
    turn2: {
      lines: [
      ...
      defaultLine: {
        ...
        dukeun: '"미안해. 그게 그렇게 신경 쓰였어? 내가 더 신경 썼어야 했는데."',
        honmi:  '"그랬구나... 나 진짜 몰랐어. 미안해."',
        dodo:   '"오늘은 그냥 자. 내일 차분하게 얘기하자."',
      },
      choices: [
        { id: 'b2t2-apologize', text: '미안하다고 한다', sub: '"미안해, 내가 눈치가 없었어."' },
        { id: 'b2t2-understand',text: '이해해보려 한다', sub: '"난 잘한다고 노력한 건데, 그렇게 생각할 줄 몰랐어. 미안해."' },
        { id: 'b2t2-explain',   text: '내 입장을 설명한다', sub: '"새우 까준 게 그렇게 상처가 됐어? 나는 그냥 자리 분위기 맞추려 한 건데."' },
        { id: 'b2t2-postpone',  text: '오늘은 그냥 자자고 한다', sub: '"오늘은 그냥 자. 내일 차분하게 얘기하자."' },
      ],
      choiceLines: {
        'b2t2-apologize':  '미안해, 내가 눈치가 없었어.',
        'b2t2-understand': '난 잘한다고 노력한 건데, 그렇게 생각할 줄 몰랐어. 미안해.',
        'b2t2-explain':    '새우 까준 게 그렇게 상처가 됐어? 나는 그냥 자리 분위기 맞추려 한 건데.',
        'b2t2-postpone':   '오늘은 그냥 자. 내일 차분하게 얘기하자.',
      },
    },
  },
  phase3: {
    turn1: {
      ...
      choices: [
        { id: 'b3t1-resolve', text: '오늘 다 해결하고 싶다', sub: '내일로 미루면 더 꼬일 것 같아' },
        { id: 'b3t1-miss',    text: '보고 싶다', sub: '목소리보다 얼굴 보고 싶어' },
        { id: 'b3t1-scared',  text: '가면 또 싸울 것 같다', sub: '지금 가는 게 맞는 건지 모르겠어' },
        { id: 'b3t1-unsure',  text: '모르겠다', sub: '가야 할지 말아야 할지' },
      ],
    },
    turn2: {
      lines: [
      ...
      choices: [
        { id: 'b3t2-go',         text: '가겠다고 한다', sub: '"나 지금 갈게."' },
        { id: 'b3t2-ask-go',     text: '가도 되냐고 묻는다', sub: '"가도 돼? 보고 싶어."' },
        { id: 'b3t2-no-go',      text: '오늘은 안 간다', sub: '"오늘은 그냥 자. 내일 차분하게 얘기하자."' },
        { id: 'b3t2-let-decide', text: '연인한테 결정을 맡긴다', sub: '"네가 원하면 갈게. 네가 결정해."' },
      ],
      choiceLines: {
        'b3t2-go':         '나 지금 갈게.',
        'b3t2-ask-go':     '가도 돼? 보고 싶어.',
        'b3t2-no-go':      '오늘은 그냥 자. 내일 차분하게 얘기하자.',
        'b3t2-let-decide': '네가 원하면 갈게. 네가 결정해.',
      },
    },
  },
  phase4: {
    turn1: {
      ...
      choices: [
        { id: 'b4t1-nervous', text: '긴장된다', sub: '막상 오니까 뭐라고 해야 할지 모르겠어' },
        { id: 'b4t1-miss',    text: '빨리 보고 싶다', sub: '얼른 문이 열렸으면 좋겠어' },
        { id: 'b4t1-unsure',  text: '어색할 것 같다', sub: '어떻게 시작해야 할지' },
        { id: 'b4t1-calm',    text: '차분하게 하자', sub: '감정적으로 굴면 안 돼' },
      ],
    },
    turn2: {
      lines: [
      ...
      choices: [
        { id: 'b4t2-text',     text: '"나 왔어." (문자)' },
        { id: 'b4t2-ask-out',  text: '"나 집 앞에 있어, 나올 수 있어?"' },
        { id: 'b4t2-bell',     text: '초인종을 누른다' },
        { id: 'b4t2-hesitate', text: '잠깐 망설이다 문자한다' },
      ],
      choiceLines: {
        'b4t2-text':     '나 왔어.',
        'b4t2-ask-out':  '나 집 앞에 있어, 나올 수 있어?',
        'b4t2-bell':     '(초인종을 누른다)',
        'b4t2-hesitate': '(잠깐 망설이다 문자한다) 나 왔어.',
      },
    },
  },
  phase5: {
    turn1: {
      ...
      choices: [
        { id: 'b5t1-nervous', text: '긴장된다', sub: '표정을 읽을 수가 없어' },
        { id: 'b5t1-relief',  text: '마음이 풀린다', sub: '보니까 괜찮아질 것 같아' },
        { id: 'b5t1-unsure',  text: '뭐라고 해야 할지 모르겠다' },
        { id: 'b5t1-hug',     text: '먼저 안아주고 싶다' },
      ],
    },
    turn2: {
      lines: [
      ...
      choices: [
        { id: 'b5t2-sorry',  text: '"미안해."' },
        { id: 'b5t2-miss',   text: '"보고 싶었어."' },
        { id: 'b5t2-ask-ok', text: '"나 때문에 많이 속상했지?"' },
        { id: 'b5t2-hug',    text: '말없이 안아준다' },
      ],
      choiceLines: {
        'b5t2-sorry':  '미안해.',
        'b5t2-miss':   '보고 싶었어.',
        'b5t2-ask-ok': '나 때문에 많이 속상했지?',
        'b5t2-hug':    '(말없이 안아준다)',
      },
    },
  },
...
const B_RESPONSES_A: Record<string, string> = {
  'a1t2-apologize':   '자기야... 미안해. 나도 많이 걱정했어. 어떤 게 그렇게 속상했는지 얘기해줘.',
  'a1t2-short-sorry': '응, 나도 미안해. 갑자기 왜 간 건지 이유는 알고 싶어.',
  'a1t2-confront':    '응? 자기야, 정말 미안해. 왜 화났는지 얘기해주면 안 될까?',
  'a1t2-vent':        '난 자기를 위해서 그런 거였어. 자기 친구들이니까 배려한 거지 다른 뜻은 없었어.',
  'a1t2-silent':      '자기야, 지금 어디야? 왜 그렇게 가버린 거야. 걱정되잖아.',
  'a2t2-vent-all':    '...자기야. 그게 그렇게 힘들었어? 나 진짜 몰랐어. 미안해.',
  'a2t2-ask-direct':  '...그 친구가 예뻐 보이긴 했어. 근데 그게 다야. 진짜로. 자기 말고 다른 마음 품은 적 없어.',
  'a2t2-ask-indirect':'으응? 난 우리 자기밖에 눈에 안 들어와서 친구들은 뭐 입고 왔는지 기억도 안 나는데.',
  'a2t2-give-up':     '자기야, 우리 이러지 않기로 했잖아. 오늘 감정은 오늘 풀기로 약속했었잖아.',
  'a3t2-meet':        '알았어. 금방 갈게. 문 앞에서 전화할게.',
  'a3t2-no-meet':     '...그래. 알았어. 잘 자, 자기야.',
  'a3t2-let-decide':  '...나 갈게. 보고 싶어, 자기.',
  'a4t2-go-out':      '...왔어.',
  'a4t2-let-in':      '들어가도 돼?',
  'a5t2-sorry':       '나도 미안해. 자기야.',
  'a5t2-miss':        '나도. 엄청.',
  'a5t2-still-angry': '...그래. 알아. 근데 나 왔잖아.',
  'a5t2-hug':         '(말없이 안아준다. 한참 동안.)',
};

const B_RESPONSES_B: Record<string, string> = {
  'b1t2-confront':  '...매번 이러는 거 아니야. 근데 오늘은 진짜 참을 수가 없었어.',
  'b1t2-worry':     '...응. 집에 잘 들어왔어. 걱정해줘서 고마워.',
  'b1t2-ask-why':   '...오늘 내 친구한테 새우도 까주고 한라봉도 까줬잖아. 나는 옆에 있었는데.',
  'b1t2-apologize': '...미안하다고 하면 다야? 내가 얼마나 속상했는지 알아?',
  'b1t2-miss':      '...나도 보고 싶어. 근데 지금은 좀 혼자 있고 싶어.',
  'b1t2-silent':    '(한참 침묵) ...아직 거기 있어?',
  'b2t2-apologize': '...고마워. 근데 미안하다는 말보다 왜 그랬는지가 더 궁금해.',
  'b2t2-understand':'...그렇게 생각해줘서 고마워. 나도 말을 했어야 했는데.',
  'b2t2-explain':   '...자리 분위기? 나는 우리 기념일인 줄 알았는데.',
  'b2t2-postpone':  '...그래. 알았어. 잘 자.',
  'b3t2-go':        '...와.',
  'b3t2-ask-go':    '...와도 돼.',
  'b3t2-no-go':     '...그래. 알았어. 잘 자.',
  'b3t2-let-decide':'...와줘.',
  'b4t2-text':      '(잠시 후) 나올게.',
  'b4t2-ask-out':   '...나갈게.',
  'b4t2-bell':      '(문이 열린다)',
  'b4t2-hesitate':  '(잠시 후) 나올게.',
  'b5t2-sorry':     '...나도 미안해.',
  'b5t2-miss':      '나도. 많이.',
  'b5t2-ask-ok':    '...응. 많이 속상했어. 근데 네가 와줘서 좋아.',
  'b5t2-hug':       '(말없이 안겨준다. 한참 동안.)',
};
...
export default function GameScene({ player, onEnding }: Props) {
  ...
  const currentTurnData = mode === 'turn1' ? phase.turn1 : phase.turn2;
  const lines = currentTurnData.lines.filter(l => l.character !== player.emotion);
  ...
  const handleTurn2Choice = (choiceId: string) => {
    // choiceLines에서 내 대사 꺼내기
    const choiceLines = (phase.turn2 as any).choiceLines as Record<string, string>;
    const myText = choiceLines[choiceId] || phase.turn2.defaultLine[player.emotion];
    const bText = B_RESPONSES[choiceId] || '...';

    // 엔딩 분기
    const undecidedIds = ['a2t2-give-up', 'a3t2-no-meet', 'b2t2-postpone', 'b3t2-no-go'];
    if (undecidedIds.includes(choiceId)) {
    ...
    // phase3 만남 → 도착 알림 추가
    const meetIds = ['a3t2-meet', 'a3t2-let-decide', 'b3t2-go', 'b3t2-ask-go', 'b3t2-let-decide'];
    if (meetIds.includes(choiceId)) {
      setMyLineText(myText);
      setBResponseText(`${bText}\n\n— 잠시 후 —\n\n나 집 앞에 도착했어.`);
    } else {
      setMyLineText(myText);
  ...
  const handleBConfirm = () => {
    // 미결 엔딩
    if (bResponseText.includes('잘 자') && bResponseText.length < 20) {
      onEnding('undecided'); return;
    }
    // 결말 엔딩
    if (phaseKey === 'phase5') {
      const isHappy = ['a5t2-sorry','a5t2-miss','a5t2-hug','b5t2-sorry','b5t2-miss','b5t2-ask-ok','b5t2-hug']
        .some(id => myLineText === (isA ? SCRIPT_A : SCRIPT_B).phase5.turn2.choiceLines?.[id]);
      onEnding(isHappy || myLineText !== '아직 화 안 풀렸어.' ? 'happy' : 'breakup');
      return;
    }
  ...
  const myDefaultLine = currentTurnData.defaultLine[player.emotion];
      ...
      <div style={{ flex: 1, padding: '16px 16px 0', maxWidth: '420px', margin: '0 auto', width: '100%', overflowY: 'auto' }}>
        ...
        {showInput && (
          <div>
            ...
            <button
              onClick={() => mode === 'turn1' ? handleTurn1Choice() : handleTurn2Choice(choices[0]?.id)}
              style={{
